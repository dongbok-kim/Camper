							...
							<tbody>
								<tr>
							  	...
							  	<tr>
									<th>주소</th>
									<td>
										<input type="text" name="ca_postcode" id="ca_postcode" value="${oriCamp.ca_postcode }" readonly/> <input type="button" onclick="sample6_execDaumPostcode()" class="btn btnPostCode" value="우편번호 찾기">
										<c:if test="${oriCamp.ca_postcode ne newCamp.ca_postcode}">
											<span style="color: red">api 변경정보 : ${newCamp.ca_postcode}</span>
										</c:if>
										<br>
										<input type="text" name="ca_addr_default" id="ca_addr_default" style="width: 99%;" value="${oriCamp.ca_addr_default }" readonly/>
										<c:if test="${oriCamp.ca_addr_default ne newCamp.ca_addr_default}">
											<span style="color: red">api 변경정보 : ${newCamp.ca_addr_default}</span>
										</c:if><br/>
										<input type="text" name="ca_addr_detail" id="ca_addr_detail" style="width: 99%;" value="${oriCamp.ca_addr_detail }"/>
							...
							<tfoot>
								<tr>
									<td colspan="2">
										...
										<input type="button" class="btn btnList" value="목록" onclick="location.href='/campingAdmList.go ' ">
									</td>
								</tr>
							</tfoot>
						</table>
